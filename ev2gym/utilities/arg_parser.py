...
def arg_parser():
    ...
    parser.add_argument("--scenario", nargs='+', default=[1], type=int,
                        help="Select the simulation scenario(s): 1 (Business Park), 2 (Public Hub), 3 (Residential Weekend). Can be multiple, e.g., --scenario 1 2 3")
